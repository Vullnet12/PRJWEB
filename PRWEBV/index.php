...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo"> Mik Mik Transport </a>
      </h1>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="login/Register_form.php" class="navbar-link" data-nav-link>
              <span>Login</span>
      ...
      <div class="header-contact">
        ...
        <div>
          <p class="contact-label"> Call In Kosovo</p>

          <a href="tel:12345678910" class="contact-number">+383 48 421 621</a>
        </div>
      ...
      <section class="section hero" aria-label="home" id="home"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-text">
              From Kosovo to every corner of the world and vice-versa.
            </p>
        ...
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="section-text">
              We are in the transport and cargo industry since 1996.
          ...
          <ul class="service-list grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/service-icon-3.png" width="80" height="60" loading="lazy" alt="Truck">
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/service-icon-1.png" width="74" height="60" loading="lazy" alt="Ship">
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/service-icon-2.png" width="60" height="60" loading="lazy" alt="Airplane">
                </div>
          ...
          <ul class="feature-list grid-list">
            ...
            <li>
              <div class="feature-card" style="--card-number: '02'">
                ...
                <p class="card-text">
                  We provide multiple drop off and pickup locations all around the world so you don't have to worry. And you should not face
                  any kind...
                </p>
            ...
            <li>
              <div class="feature-card" style="--card-number: '03'">
                ...
                <p class="card-text">
                  A tracking number for the entire process. so that you can find the exact position at any time you please. 
              ...
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <time class="card-meta" datetime="2022-08-02">
                    <span class="span">02</span> Dec
                  </time>

                  <h3 class="h3 card-title">
                    <a href="#">
                      The best of the best , going forward together , new technology avalible. your only logistic
                      partner.
                    </a>
                  </h3>

                  <p class="card-text">
                    New tracking chips have been installed in our transportation vehicles, now our costumers
                    can see the real time locations.
              ...
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <time class="card-meta" datetime="2022-08-21">
                    <span class="span">25</span> Dec
                  
                  </time>

                  <h3 class="h3 card-title">
                    <a href="#">
                      Visit from Kosovo officials and Albania officials.
                      
                    </a>
                  </h3>

                  <p class="card-text">
                    Kosovo and Albanian officials have visited our warehouses and offices in Kosovo(Prishtina) And
                    Albania(Durrës),we had wonderful meetings,we had a talk about transporting the "948" Stadium that has 
                    been gifted to Kosovo by Qatar.
    ...
    <div class="container">
      ...
      <div class="footer-top section">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">
            Vist all our social media paltforms.
          </p>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; 2022 Mik Mik Transport. All Rights Reserved by <a href="#" class="copyright-link">vr57902 And ms57917</a>
        </p>
      </div>
